...
### Description of the current system in place or lack of system.

### Description of current system in place or lack of system.

* Who are the users?
  * The users are people interested in **finance** or the **economy** and our tool can be easily integrated in websites using the `Django` or `Flask`framework for python or in applications on desktop using `Cython/CPython` and `C++` or mobile through `Java` _\(with `Jython`_\) and `Swift`.
* Who are the users?
...
* Show an understanding of how to model a **complex** system by only including **essential** details.
...
### Final Comments and review of the project
